...
<body>
    ...
    <main>
        ...
        ?>
        <form action="/phpmotors/vehicles/index.php/?action=classification" method="post">
            <button type="submit">Add Classification</button>
            <button type="submit" formaction="/phpmotors/vehicles/index.php/?action=vehicle">Add Vehicle</button>
        </form>
    </main>
    <footer>
        <hr>
